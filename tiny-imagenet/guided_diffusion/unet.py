...
class UNetModel(nn.Module):
    ...
    def __init__(
        ...
        if predict_class:
            ...
            self.classifier_head = CNN_simple(model_channels * 2, 128, num_classes)
    ...
    def forward(self, x, timesteps, y=None, return_y_pred=False):
        """
        ...
        if self.predict_class and return_y_pred:
            y_pred = self.classifier_head(h)
        ...
        output = self.out(h) if not return_y_pred else self.out(h), y_pred
        return output
